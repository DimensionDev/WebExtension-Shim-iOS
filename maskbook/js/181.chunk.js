(globalThis["webpackJsonp"] = globalThis["webpackJsonp"] || []).push([[181,182],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "claimRedPacket", function() { return claimRedPacket; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "discoverRedPacket", function() { return discoverRedPacket; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRedPacketsFromDB", function() { return getRedPacketsFromDB; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRedPacketFromDB", function() { return getRedPacketFromDB; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRedPacketsFromChain", function() { return getRedPacketsFromChain; });
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(96);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(144);
/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(645);
/* harmony import */ var _web3_pipes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(84);
/* harmony import */ var _extension_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(18);
...
async function claimRedPacket(from, rpid, password) {
    const host = 'https://redpacket.gives';
    const x = 'a3323cd1-fa42-44cd-b053-e474365ab3da';
    const chainId = await _extension_service__WEBPACK_IMPORTED_MODULE_6__[/* default */ "b"].Ethereum.getChainId(from);
    const network = Object(_web3_pipes__WEBPACK_IMPORTED_MODULE_5__[/* resolveChainName */ "c"])(chainId).toLowerCase();
    ...
    const jwt_encoded = {
        ...
        signature: await _extension_service__WEBPACK_IMPORTED_MODULE_6__[/* default */ "b"].Ethereum.sign(verify, from, chainId),
    };
    const pay = await fetch(`${host}/please?payload=${jsonwebtoken__WEBPACK_IMPORTED_MODULE_0__["sign"](jwt_encoded, x, { algorithm: 'HS256' })}&network=${network}`);
    if (!pay.ok)
        throw new Error('Pay failed');
    return { claim_transaction_hash: await pay.text() };
}
async function discoverRedPacket(from, payload) {
    var _a;
    if (!payload.rpid)
        return;
    if (!payload.password)
        return;
    const record_ = await _database__WEBPACK_IMPORTED_MODULE_4__[/* getRedPacket */ "c"](payload.rpid);
    const record = {
        id: payload.rpid,
        from: (record_ === null || record_ === void 0 ? void 0 : record_.from) || from,
        payload: (_a = record_ === null || record_ === void 0 ? void 0 : record_.payload) !== null && _a !== void 0 ? _a : payload,
    };
    _database__WEBPACK_IMPORTED_MODULE_4__[/* addRedPacket */ "b"](record);
    _helpers__WEBPACK_IMPORTED_MODULE_3__[/* RedPacketMessage */ "b"].events.redPacketUpdated.sendToAll(undefined);
}
function getRedPacketsFromDB() {
    return _database__WEBPACK_IMPORTED_MODULE_4__[/* getRedPackets */ "d"]();
}
function getRedPacketFromDB(rpid) {
    return _database__WEBPACK_IMPORTED_MODULE_4__[/* getRedPacket */ "c"](rpid);
}
async function getRedPacketsFromChain(from, startBlock) {
    const url = new URL(_constants__WEBPACK_IMPORTED_MODULE_2__[/* RED_PACKET_HISTORY_URL */ "d"]);
    url.searchParams.set('chainId', String(await _extension_service__WEBPACK_IMPORTED_MODULE_6__[/* default */ "b"].Ethereum.getChainId(from)));
...
var bufferEqual = __webpack_require__(1808);
var Buffer = __webpack_require__(73).Buffer;
var crypto = __webpack_require__(270);
var formatEcdsa = __webpack_require__(1809);
var util = __webpack_require__(267);
...
/*global exports*/
var SignStream = __webpack_require__(1807);
var VerifyStream = __webpack_require__(1811);
...
/*global module*/
var Buffer = __webpack_require__(73).Buffer;
var DataStream = __webpack_require__(1753);
var jwa = __webpack_require__(1754);
var Stream = __webpack_require__(300);
var toString = __webpack_require__(1755);
var util = __webpack_require__(267);
...
var Buffer = __webpack_require__(22).Buffer; // browserify
...
var getParamBytesForAlg = __webpack_require__(1810);
