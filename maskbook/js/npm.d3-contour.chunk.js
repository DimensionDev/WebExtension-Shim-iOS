(globalThis["webpackJsonp"] = globalThis["webpackJsonp"] || []).push([[35],{
...
/* harmony default export */ var src_contours = (function() {
  var dx = 1,
      dy = 1,
      threshold = src["i" /* thresholdSturges */],
      smooth = smoothLinear;
  ...
  function contours(values) {
    ...
    if (!Array.isArray(tz)) {
      ...
      tz = Object(src["k" /* tickStep */])(start, stop, tz);
      tz = Object(src["h" /* range */])(Math.floor(start / tz) * tz, Math.floor(stop / tz) * tz, tz);
    } else {
...
/* harmony default export */ var src_density = (function() {
  ...
  function density(data) {
    ...
    if (!Array.isArray(tz)) {
      ...
      tz = Object(src["k" /* tickStep */])(0, stop, tz);
      tz = Object(src["h" /* range */])(0, Math.floor(stop / tz) * tz, tz);
      tz.shift();
    }
